...
public class Category_SubController {
    ...
    public ResponseEntity<List<Category_Sub>> findAllByCategory(){
        List<Category_Sub> list=category_subService.findAllByCategory(Long.parseLong("3"));
        return new ResponseEntity<List<Category_Sub>>(list, HttpStatus.OK);
    }
}
